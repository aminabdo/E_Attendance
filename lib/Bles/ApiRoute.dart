...
class ApiRoutes {
  ...
  static String make_bill(int orderID, int discount_type, double discount,
      int tax1_type, int tax1, int tax2_type, int tax2, double paid) {
  ...
  static String myAttendance() {
    return "Attendence/my_attendence";
  }
