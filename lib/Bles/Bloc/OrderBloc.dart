...
class OrderBloc extends BaseBloc {
  ...
  BehaviorSubject<AddpdOrderResponse> _add_pd_order = BehaviorSubject<AddpdOrderResponse>();
  ...
  Future<AddpdOrderResponse> addOrder(AddpdOrderRequest request) async {
    ...
    _add_pd_order.value = response;
    _add_pd_order.value.loading = false ;
    return response;
  }
  ...
  Future<BaseResponse> addProductToOrder(AddProductTopdOrder request) async {
    ...
    _add_product_to_pd_order.value = response;
