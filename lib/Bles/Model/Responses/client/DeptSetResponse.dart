...
class DeptSetResponse extends BaseResponse {
  ...
  static DeptSetResponse fromMap(Map<String, dynamic> map) {
    if (map == null) return null;
    DeptSetResponse deptSetResponse = DeptSetResponse();
    deptSetResponse.status = map['status'];
    deptSetResponse.data = DataBean.fromMap(map['data']);
    deptSetResponse.message = map['message'];
    return deptSetResponse;
  }
